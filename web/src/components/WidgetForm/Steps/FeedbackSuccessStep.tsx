...
export function FeedbackSuccessStep({
    ...
    return (
        <>
            ...
            <div
                className="tw-flex tw-flex-col tw-items-center tw-py-10 tw-w-[304px]">
                ...
                <span className="tw-text-xl tw-mt-2 tw-text-white dark:tw-text-gray-600">
                    Agradecemos o feedback!
                </span>
                <button
                    type="button"
                    onClick={onFeedbackRestartRequested}
                    className="tw-py-2 tw-px-6 tw-mt-6 tw-bg-zinc-800 tw-rounded-md tw-border-transparent tw-text-sm tw-leading-6 hover:tw-bg-zinc-700 tw-transition-colors focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-offset-2 focus:tw-ring-offset-zinc-900 focus:tw-ring-brand-500 tw-text-white dark:tw-bg-brand-500">
                    Quero enviar outro
                </button>
            </div>
        </>
